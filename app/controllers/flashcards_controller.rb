class FlashcardsController < ApplicationController
  ...
  def create
    ...
    if the_flashcard.valid?
      the_flashcard.save
      redirect_to("/flashcards", { :notice => "Flashcard created successfully." })
    else
      redirect_to("/flashcards", { :alert => the_flashcard.errors.full_messages.to_sentence })
    end
  end
  ...
  def destroy
    ...
    the_flashcard.destroy

    redirect_to("/flashcards", { :notice => "Flashcard deleted successfully." } )
  end
end
